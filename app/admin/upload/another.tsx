...
import { FileText, Youtube, Type, FileAudio, FileVideo, Trash2, ChevronDown, ChevronUp, File, Upload } from 'lucide-react';
...
export default function KnowledgeBasePage() {
  const [resources, setResources] = useState<Resource[]>(knowledgeBaseData.resources);
      ...
      <div className="container px-4 py-8 mx-auto">
        ...
        <header className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{knowledgeBaseData.name} Knowledge Base</h1>
              <p className="mt-1 text-gray-500 dark:text-gray-400">{resources.length} Resources Available</p>
            </div>
