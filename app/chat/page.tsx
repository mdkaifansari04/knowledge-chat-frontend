...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen px-4 bg-gradient-to-br from-white via-gray-100 to-gray-200 dark:bg-gradient-to-br via-zinc-900 to-black dark:from-black dark:via-zinc-800/40 dark:to-black">
